...
import { useCanvas, type GenerateImageNodeData, type CanvasNode } from "@/store/canvasStore";

export function GenerateImageNode({ id, data }: { id: string; data: GenerateImageNodeData }) {
    ...
    setTimeout(() => {
      ...
      updateNode(
        ...
        (n) =>
          ({
            ...n,
            data: { ...n.data, src: `https://picsum.photos/seed/${seed}/400/225` },
          }) as CanvasNode,
      );
      setBusy(false);
    }, 2000);
